...
function showMoney() {
  ...
  let walletOpen =
    '<img src="./img/icon-wallet-open.png" style="height:2.5rem;"/>';
  let walletClose =
    '<img src="./img/icon-wallet-close.png" style="height:2.5rem;"/>';
...
function getChange(num) {
  ...
  let coins = [];
  let result = "";
  let rubl1 = '<img src="./img/icon-1rubl.png" style="height:2.5rem;"/>';
  let rubl2 = '<img src="./img/icon-2rublya.png" style="height:2.5rem"/>';
  let rubl5 = '<img src="./img/icon-5rubley.png" style="height:2.5rem"/>';
  let rubl10 = '<img src="./img/icon-10rubley.png" style="height:2.5rem"/>';
...
function isCooking(name) {
  let coffeeImg = '<img src="./img/coffee-progress.gif" style="height:4rem;"/>';
  if (name === "Молоко") {
    let out = `
...
function cofeeCooked(name) {
  let coffeeImg = '<img src="./img/coffee-cat.png" class="coffee-cat"/>';
  if (name === "Молоко") {
    let out = `
...
function noMoney(name) {
  let poverty = '<img src="./img/icon-poverty.png" style="height:2.5rem"/>';
